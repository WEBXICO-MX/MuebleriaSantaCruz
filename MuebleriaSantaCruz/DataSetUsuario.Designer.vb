...
Namespace DataSetUsuarioTableAdapters
    ...
    Partial Public Class usuariosTableAdapter
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DataSetUsuario.usuariosDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DataSetUsuario.usuariosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
