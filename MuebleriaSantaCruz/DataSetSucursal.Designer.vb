...
Namespace DataSetSucursalTableAdapters
    ...
    Partial Public Class sucursalesTableAdapter
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As DataSetSucursal.sucursalesDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As DataSetSucursal.sucursalesDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
