...
Namespace DataSetPuestoTableAdapters
    ...
    Partial Public Class puestosTableAdapter
        ...
        Public Overridable Overloads Function Fill(ByVal dataTable As DataSetPuesto.puestosDataTable) As Integer
        ...
        Public Overridable Overloads Function GetData() As DataSetPuesto.puestosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
