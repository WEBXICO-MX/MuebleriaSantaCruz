...
Namespace DataSetModuloTableAdapters
    ...
    Partial Public Class modulosTableAdapter
        ...
        Public Overridable Overloads Function Fill(ByVal dataTable As DataSetModulo.modulosDataTable) As Integer
        ...
        Public Overridable Overloads Function GetData() As DataSetModulo.modulosDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
