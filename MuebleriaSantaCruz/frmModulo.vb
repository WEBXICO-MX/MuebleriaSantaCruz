...
Public Class frmModulo
    ...
    Public Sub Nuevo()
        ...
        'Crear una consulta
        Dim Consulta As String = "SELECT id FROM Modulos ORDER BY id DESC"
    ...
    Public Sub InsertaNuevo()
        ...
        'Crear una consulta
        Dim Consulta As String = "INSERT INTO Modulos (id, nombre,activo,fecha_reg,fecha_mod) VALUES (" & txtID.Text & ",'" & txtNombre.Text & "'," & (If(cbxActivo.Checked, 1, 0)) & ",GETDATE(),NULL)"
        Orden = New SqlCommand(Consulta, objcon.con)
        ...
        Try
            ...
            For Fila = 0 To ModulosDataGridView.Rows.Count - 1
                If (ModulosDataGridView.Item(1, Fila).Value = txtNombre.Text) Then
                    ModulosDataGridView.Item(0, Fila).Selected = True
                    Exit For
                End If
            Next Fila
            ...
            MessageBox.Show("El módulo '" & txtNombre.Text & "' ha sido guardado", "Guardar", MessageBoxButtons.OK)

            LimpiarCajasdeTexto()
            lbtipoestado.Visible = False
            ModulosDataGridView.Enabled = True
        Catch ex As SqlException
    ...
    Public Sub Editar()
        ...
        'Crear una consulta
        Dim Consulta As String = "UPDATE Modulos SET nombre = '" & txtNombre.Text & "', activo = " & (If(cbxActivo.Checked, 1, 0)) & ",  fecha_mod = GETDATE() WHERE id = " & txtID.Text
        Orden = New SqlCommand(Consulta, objcon.con)
    ...
    Private Sub PegarDatosTabla_CajasdeTexto(ByVal F As Integer)
        txtID.Text = ModulosDataGridView.Rows(F).Cells(0).Value
        txtNombre.Text = ModulosDataGridView.Rows(F).Cells(1).Value
        cbxActivo.Checked = ModulosDataGridView.Rows(F).Cells(4).Value
    End Sub
    ...
    Private Sub ModulosDataGridView_CellClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles ModulosDataGridView.CellClick
        If (ModulosDataGridView.Enabled = True) Then
    ...
    Private Sub ModulosDataGridView_RowEnter(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles ModulosDataGridView.RowEnter
        If (ModulosDataGridView.Enabled = True) Then
            If (e.RowIndex >= 0) Then
                PegarDatosTabla_CajasdeTexto(e.RowIndex)
                EstadoBotones(True, False, True, True, True)
    ...
    Private Sub btnuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnuevo.Click
        ...
        ModulosDataGridView.Enabled = False
    ...
    Private Sub btguardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btguardar.Click
        ...
        If (txtNombre.Text.Length = 0) Then
            ErrorProvider1.SetError(txtNombre, "Capture el nombre del módulo")
            txtNombre.Focus()
            Exit Sub
        End If
    ...
    Private Sub bteditar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bteditar.Click
        If (txtID.Text <> "") Then
            Dim F As Integer = ModulosDataGridView.CurrentCellAddress.Y
            ...
            ModulosDataGridView.Enabled = False
        Else
            MessageBox.Show("Seleccione un modulo para editar", "Editar", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
    End Sub
    ...
    Private Sub frmModulo_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        ...
        If (ModulosBindingSource.Count = 0) Then
