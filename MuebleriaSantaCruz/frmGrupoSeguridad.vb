...
Public Class frmGrupoSeguridad
    ...
    Public Sub Nuevo()
        ...
        'Crear una consulta
        Dim Consulta As String = "SELECT id FROM Grupos_seguridad ORDER BY id DESC"
    ...
    Public Sub InsertaNuevo()
        ...
        'Crear una consulta
        Dim Consulta As String = "INSERT INTO Grupos_seguridad (id, nombre,activo,fecha_reg,fecha_mod) VALUES (" & txtID.Text & ",'" & txtNombre.Text & "'," & (If(cbxActivo.Checked, 1, 0)) & ",GETDATE(),NULL)"
        Orden = New SqlCommand(Consulta, objcon.con)
        ...
        Try
            ...
            For Fila = 0 To Grupos_seguridadDataGridView.Rows.Count - 1
                If (Grupos_seguridadDataGridView.Item(1, Fila).Value = txtNombre.Text) Then
                    Grupos_seguridadDataGridView.Item(0, Fila).Selected = True
                    Exit For
                End If
            Next Fila
            ...
            MessageBox.Show("El grupo de seguridad '" & txtNombre.Text & "' ha sido guardado", "Guardar", MessageBoxButtons.OK)

            LimpiarCajasdeTexto()
            lbtipoestado.Visible = False
            Grupos_seguridadDataGridView.Enabled = True
        Catch ex As SqlException
            If (ex.Number = 2601) Then
                MessageBox.Show("El grupo de seguridad ya existe", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Public Sub Editar()
        ...
        'Crear una consulta
        Dim Consulta As String = "UPDATE Grupos_seguridad SET nombre = '" & txtNombre.Text & "', activo = " & (If(cbxActivo.Checked, 1, 0)) & ",  fecha_mod = GETDATE() WHERE id = " & txtID.Text
        Orden = New SqlCommand(Consulta, objcon.con)
        ...
        Catch ex As SqlException
            If (ex.Number = 2601) Then
                MessageBox.Show("El grupo de seguridado ya existe", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            ElseIf (ex.Number = 2627) Then
                MessageBox.Show("El ID ya existe", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Else
                MsgBox("Error: " + ex.Message)
    ...
    Private Sub PegarDatosTabla_CajasdeTexto(ByVal F As Integer)
        txtID.Text = Grupos_seguridadDataGridView.Rows(F).Cells(0).Value
        txtNombre.Text = Grupos_seguridadDataGridView.Rows(F).Cells(1).Value
        cbxActivo.Checked = Grupos_seguridadDataGridView.Rows(F).Cells(4).Value
    End Sub
    ...
    Private Sub Grupos_seguridadDataGridView_CellClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Grupos_seguridadDataGridView.CellClick
        If (Grupos_seguridadDataGridView.Enabled = True) Then
    ...
    Private Sub Grupos_seguridadDataGridView_RowEnter(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles Grupos_seguridadDataGridView.RowEnter
        If (Grupos_seguridadDataGridView.Enabled = True) Then
            If (e.RowIndex >= 0) Then
                PegarDatosTabla_CajasdeTexto(e.RowIndex)
                EstadoBotones(True, False, True, True, True)
    ...
    Private Sub btnuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnuevo.Click
        ...
        Grupos_seguridadDataGridView.Enabled = False
    ...
    Private Sub btguardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btguardar.Click
        ...
        If (txtNombre.Text.Length = 0) Then
            ErrorProvider1.SetError(txtNombre, "Capture el nombre del grupo de seguridad")
            txtNombre.Focus()
            Exit Sub
        End If
    ...
    Private Sub bteditar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bteditar.Click
        If (txtID.Text <> "") Then
            Dim F As Integer = Grupos_seguridadDataGridView.CurrentCellAddress.Y
            ...
            Grupos_seguridadDataGridView.Enabled = False
        Else
            MessageBox.Show("Seleccione un grupo de seguridad para editar", "Editar", MessageBoxButtons.OK, MessageBoxIcon.Information)
        End If
    End Sub
    ...
    Private Sub frmGrupoSeguridad_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        ...
        If (Grupos_seguridadBindingSource.Count = 0) Then
            EstadoBotones(True, False, False, False, False)
        Else
            EstadoBotones(True, False, False, False, True)
        End If

        Grupos_seguridadDataGridView.ClearSelection()
    End Sub
